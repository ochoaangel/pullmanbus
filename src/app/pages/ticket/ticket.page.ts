...
export class TicketPage implements OnInit {
  ...
  continuar() {
    ...
    if (this.compras.length === 0 && this.mys.way === 'go') {
      ...
      // console.log('this.mys.ticket', JSON.stringify(this.mys.ticket));
